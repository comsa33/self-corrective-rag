...
% Significance: p < 0.001 above TARA error bar on 2Wiki
% TARA is 5th of 5 bars → xshift = +14pt from group center
\node[font=\scriptsize, anchor=south, yshift=2pt, xshift=14pt]
    at (axis cs:2WikiMultiHopQA, 0.648) {$p{<}0.001$};
