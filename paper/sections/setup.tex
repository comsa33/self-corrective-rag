...
\paragraph{Models}
All experiments use Gemini Flash Lite~\cite{geminiteam2023gemini}\footnote{Model~ID: \texttt{gemini/gemini-3.1-flash-lite-preview}} for all four LLM slots (preprocessing, evaluation, generation, agent) via LiteLLM.
