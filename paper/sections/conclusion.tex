...
Trajectory analysis reveals consistent convergence on structured protocols (decompose--search--evaluate), guided by typed Signatures and ReAct reasoning, with domain-adaptive tool selection arising without explicit instruction.
